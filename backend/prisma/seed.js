...
async function main() {
    ...
    const runnerPassword = await bcryptjs_1.default.hash("123456", 10);
    ...
    await prisma.category.upsert({
        ...
        create: {
            ...
            minAge: 16,
            maxAge: 99,
            gender: client_1.Gender.F,
            price: 89.9,
            maxSlots: 250,
        },
    });
    const checkpoints = [
        { name: "Largada", kmMark: 0, type: client_1.CheckpointType.START, order: 1 },
        { name: "Km 1", kmMark: 1, type: client_1.CheckpointType.SPLIT, order: 2 },
        { name: "Km 2", kmMark: 2, type: client_1.CheckpointType.SPLIT, order: 3 },
        { name: "Km 3", kmMark: 3, type: client_1.CheckpointType.SPLIT, order: 4 },
        { name: "Km 4", kmMark: 4, type: client_1.CheckpointType.SPLIT, order: 5 },
        { name: "Chegada", kmMark: 5, type: client_1.CheckpointType.FINISH, order: 6 },
    ];
    ...
    const payment = await prisma.payment.upsert({
        ...
        update: { status: client_1.PaymentStatus.PAID, method: "stripe", amount: 89.9, transactionId: "seed_tx" },
        create: {
    ...
    await prisma.timingResult.upsert({
        ...
        update: {
            bibNumber: 1,
            chipId: "seed-chip-1",
            status: client_1.ResultStatus.FINISHED,
